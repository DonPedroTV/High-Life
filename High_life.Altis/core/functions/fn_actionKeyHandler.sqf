...
if (playerSide isEqualTo independent && {player getVariable ["isEscorting",false]} && (!(_curObject getVariable ["restrained",false]))) exitWith {
    [] call life_fnc_copInteractionMenu;
};
...
if ((_curObject getVariable ["tied",false]) && !dialog && playerSide isEqualTo west && {player distance _curObject < 3}) then {
        [_curObject] call life_fnc_copInteractionMenu;
    };
    if ((!(_curObject getVariable ["restrained",false])) && !dialog && playerSide isEqualTo civilian && {player distance _curObject < 3}) then {
        [_curObject] call life_fnc_copInteractionMenu;
    };
    if ((!(_curObject getVariable ["restrained",false])) && !dialog && playerSide isEqualTo independent && {player distance _curObject < 3}) then {
        [_curObject] call life_fnc_copInteractionMenu;
    };
} else {

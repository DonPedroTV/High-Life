...
_nazwa = FETCH_CONFIG2(getText,"CfgVehicles",(typeOf _vehicle),"displayName");
_log = format ["%1, %2 sprzedal %3 za %4", name player, getPlayerUID player, _nazwa, [_price] call life_fnc_numberText];
[_log, "dziupla"] remoteExecCall ["A3Log", 2];
player say3D "buy";
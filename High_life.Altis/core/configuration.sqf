...
life_commonSiteTable = [
    ...
    ["decorativeclaypipe",45],
    ["decorativeclaybowl",45],
    ["decorativeclaypot",45],
...
life_rareSiteTable = [
    ...
    ["decorativeclaypipe",40],
    ["decorativeclaybowl",40],
    ["decorativeclaypot",40],
    ...
    ["jewelencrustedsilver",4],
    ["jewelencrustedgold",2]
];

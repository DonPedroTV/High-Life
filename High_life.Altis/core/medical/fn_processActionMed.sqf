...
if (side player != independent) exitWith {hint "Nie jestes medykiem!";};
...
if (_hasLicense) then {
    for "_i" from 0 to 1 step 0 do {
        sleep  0.28;
        _cP = _cP + (0.01 * (missionNamespace getVariable ["mav_ttm_var_processMultiplier", 1]));        _progress progressSetPosition _cP;

//this addAction ["<t color='#0099FF'>Połóż się</t>","bed\laydown.sqf","",0,false,false,"",'player distance _target < 2 && !(_target getVariable["occupied",false]) && isNil "life_laydown" && isNil "life_action_getup"'];
_bed = _this select 0;

...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_wyrzucitem,CLIENT)
		F(life_pInact_curTarget,CLIENT)
		F(life_fnc_tieing,CLIENT)
		F(life_fnc_tieingb,CLIENT)
		F(life_fnc_gagged,CLIENT)
		F(life_fnc_createmarker,CLIENT)
		F(life_fnc_zatrzymaj2,CLIENT)
		F(life_fnc_jedziemedyk2,CLIENT)

		...
		class Offroad_01_base_F
		{
			...
			class RawModifications
			{
				...
				class HideDoors
				{
					...
					displayText = "Ukryj/Pokaz Drzwi";
					price = 4000;
				};
				class HideBackpacks
				{
					parts[] = {"HideBackpacks"};
					displayText = "Ukryj/Pokaz Plecaki";
					price = 4000;
				};
				class HideBumper
				{
					parts[] = {"HideBumper1","HideBumper2"};
					displayText = "Ukryj/Pokaz Zdezaki";
					price = 4000;
				};
				class HideConstruction
				{
					parts[] = {"HideConstruction"};
					displayText = "Ukryj/Pokaz Belke";
					price = 4000;
				};
				class HideServices
				{
					parts[] = {"HideServices"};
					displayText = "Ukryj/Pokaz swiatla";
					price = 20000;
				};
			};
			class Colors
			{
				...
				class RGB
				{
					displayText = "Zmiana koloru samochodu(RGB)";
					price = 25000;
					texture = "";
				};
				class Red
				{
					...
					displayText = "Czerwony (Metaliczny)";
					price = 2000;
				...
				class BlueMetallic
				{
					...
					displayText = "Niebieski (Metaliczny)";
					price = 2000;
				...
				class GreenOcean
				{
					...
					displayText = "Zielony/Niebieski Ocean Fade";
					price = 2000;
					texture = "a3\soft_f\offroad_01\data\offroad_01_ext_base03_co.paa";
				...
				{
					displayText = "Zielony (Metaliczny)";
					price = 2000;
			...
			class Nitro
			{
				...
				class Nitro1
				{
					displayText = "Nitro poziom 1";
					timesUseable = 1;
					price = 15000;
				};
				class Nitro2
				{
					displayText = "Nitro poziom 2";
					timesUseable = 2;
					price = 25000;
				};
				class Nitro3
				{
					displayText = "Nitro poziom 3";
					timesUseable = 3;
					price = 40000;
				};
			};
